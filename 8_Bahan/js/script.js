...
function openTab(evt, tabName) {
  ...
  switch (tabName) {
    case "tab1":
      heroImage.src = "../8_Bahan/img/Pesona Image - Alam.svg";
      heroImage.title = "Destinasi Alam";
      break;
    case "tab2":
      heroImage.src = "../8_Bahan/img/Pesona Image - Penginapan.svg";
      heroImage.title = "Pilihan Akomodasi";
      break;
    case "tab3":
      heroImage.src = "../8_Bahan/img/Pesona Image - Belanja.svg";
